  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2.5 border border-input rounded-md py-2.5 text-sm font-medium hover:bg-accent transition disabled:opacity-50"
      >
