...
| Page | Required APIs |
|---|---|
| `/` (Dashboard) | `/api/accounts`, `/api/transactions`, `/api/stocks`, `/api/crypto`, `/api/gold`, `/api/stocks/sales`, `/api/crypto/sales`, `/api/gold/sales`, `/api/market/prices` |
| `/accounts` | `/api/accounts` |
| `/accounts/[id]` | `/api/accounts`, `/api/transactions` |
